...
api_t device_api[] =
{
    ...
    {"disp_px", disp_px_callback, "pixels"},
...
//     ili9341_hal.delay_ms = sleep;
// } ili9341_hal_t;

// static ili9341_hal_t my_hal = {
...
int main()
{
    ...
    ili9341_draw_text(&ili9341_display, 20, 100, "Hello, World!", &jetbrains_font, COLOR_PURPLE, COLOR_BLACK);
    ili9341_draw_text(&ili9341_display, 20, 116, "VAHAHAHHAHAHAHA", &jetbrains_font, COLOR_YELLOW, COLOR_BLACK);
